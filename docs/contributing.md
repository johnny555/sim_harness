...
# Or install manually
pip install pytest pytest-cov mypy ruff mkdocs-material
```
...
4. Document in `docs/api/primitives.md`
...
- Open a [Discussion](https://github.com/johnny555/sim_harness/discussions) for questions
- Open an [Issue](https://github.com/johnny555/sim_harness/issues) for bugs or feature requests
